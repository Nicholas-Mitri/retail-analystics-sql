...
CREATE TRIGGER trg_categories_no_self_ref_ins
BEFORE INSERT ON categories
FOR EACH ROW
BEGIN
    IF NEW.parent_category_id = NEW.category_id THEN
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'Category cannot reference itself';
    END IF;
END//

CREATE TRIGGER trg_categories_no_self_ref_upd
